...
def on_ui_settings():
    ...
    addopt('nai_bypass_geninfo_transfer', shared.OptionInfo(False, "Skip transferring original metadata to post-processed images. Potential loop bypass.",gr.Checkbox, section=section))
