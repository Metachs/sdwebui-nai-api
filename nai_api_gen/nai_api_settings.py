...
def on_ui_settings():
    ...
    addopt('nai_bypass_geninfo_transfer', shared.OptionInfo(False, "Lockup/Stall workaround, try enabling if sd-webui regularly stalls during image generation with NAI.",gr.Checkbox, section=section))
    addopt('nai_bypass_geninfo_transfer', shared.OptionInfo(False, "Lockup/Stall workaround, try enabling if sd-webui regularly stalls for several minutes during image generation with NAI.",gr.Checkbox, section=section))
