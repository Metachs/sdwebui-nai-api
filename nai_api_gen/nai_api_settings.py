...
def on_ui_settings():
    ...
    addopt('nai_api_retry', shared.OptionInfo(2, "Request Retry Attempts - Number of times to retry a failed query before giving up",gr.Slider, {"minimum": 0, "maximum": 3, "step": 1}, section=section))
